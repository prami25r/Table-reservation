...
import Cancelled from "../../../src/screens/reservation/cancelled";
...
describe("Cancelled Screen", () => {
  ...
  test("renders only Cancelled items", () => {
    render(<Cancelled data={sampleData} />);
  ...
  test("filters by restaurantFilter", () => {
    render(<Cancelled data={sampleData} restaurantFilter={10} />);
  ...
  test("sorts by date ASC", () => {
    ...
    render(<Cancelled data={sampleData} sort={sort} />);
